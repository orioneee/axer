...
**Note**: Axer is currently in alpha (`{{AXER_VERSION}}`) and is not considered stable. It supports
...
- **Stability**: The library is in beta (`{{AXER_VERSION}}`) and may have bugs or breaking changes
  in future releases.
