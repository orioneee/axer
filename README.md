...
Add the dependencies to your project (`1.2.8` is the latest version; check [Releases](https://github.com/orioneee/Axer/releases)):

```kotlin
implementation("io.github.orioneee:axer:1.2.8")
```

For production, use the no-op variant to avoid runtime overhead and source changes:

```kotlin
implementation("io.github.orioneee:axer-no-op:1.2.8")
```
