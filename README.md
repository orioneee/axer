...
**Note**: Axer is currently in alpha (`1.0.0-beta03`) and is not considered stable. It supports Android, JVM, and iOS platforms. However, iOS has limitations: stack traces and fatal crash capturing via `installAxerErrorHandler` are not supported.
...
- **Stability**: The library is in beta (`1.0.0-beta03`) and may have bugs or breaking changes in future releases.
